/*
	Header for the 'xmltag' library by Claude SIMON (csimon at zeusw dot org)
...
#define	XMLTAG_VERSION	"$Revision$"

#define XMLTAG_OWNER		"Claude SIMON"

#include "ttr.h"

extern class ttr_tutor &XMLTAGTutor;

#if defined( XXX_DBG ) && !defined( XMLTAG_NODBG )
#define XMLTAG_DBG
#endif
...
/* Addendum to the automatic documentation generation part. */
//D Hierarchically Organized Structures TAG.
/* End addendum to automatic documentation generation part. */

#error "Obsolete. Use 'XMLELM' instead."
...
namespace xmltag {
	...
	E_TYPEDEF( epeios::row_t__, tag_row__ );
