/*
  Header for the 'brkrqm' library by Claude SIMON (http://zeusw.org/intl/contact.html)
...
#define BRKRQM_OWNER		"the Epeios project (http://zeusw.org/epeios/)"
...
#define BRKRQM_INVALID_COMMAND		((unsigned long)BSO_USHORT_MAX)
#define BRKRQM_COMMAND_MAX			( BRKRQM_INVALID_COMMAND - 1UL )

#define BRKRQM_INVALID_TYPE			((unsigned long)BSO_USHORT_MAX)
#define BRKRQM_TYPE_MAX				( BRKRQM_INVALID_TYPE - 1UL )

#define BRKRQM_INVALID_OBJECT		((unsigned long)BSO_USHORT_MAX)
#define BRKRQM_OBJECT_MAX			( BRKRQM_INVALID_OBJECT - 1UL )
