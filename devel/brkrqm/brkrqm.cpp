/*
  'brkrqm' library by Claude SIMON (http://zeusw.org/intl/contact.html)
...
tym::row__ brkrqm::descriptions_::Position( const description_ &Description ) const
{
	tym::row__ Position = E_CONTAINER_( description_ )::First();
ERRProlog
