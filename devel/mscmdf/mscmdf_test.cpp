/*
  Test source for the 'mscmdf' library by Claude SIMON (http://zeusw.org/intl/contact.html).
...
ERRBegin
	IFlow.Init( "H:\\MUSIQUE\\VK\\dumpM0.mid" );
...
ERRFProlog
ERRFBegin
	fout << "Test of library " << MSCMDFTutor.Name << ' ' << __DATE__" "__TIME__"\n";
...
ERRFEnd
	fout << "\nEnd of program " << MSCMDFTutor.Name << ".\n";
ERRFEpilog
	return ExitCode;
}
