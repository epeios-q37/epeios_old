/*
	'xmlprs' library by Claude SIMON (csimon at zeusw dot org)
...
using xmldcm::document_filler__;
using xmldbs::database_filler__;
...
static void DCMStartElementHandler_(
	...
	const XML_Char **Atts )
{
	StartElementHandler_( *(document_filler__ *)UserData, Name, Atts );
}
...
static void DBSStartElementHandler_(
	...
	const XML_Char **Atts )
{
	StartElementHandler_( *(database_filler__ *)UserData, Name, Atts );
}
...
static void DCMEndElementHandler_(
	...
	const XML_Char *Name )
{
	EndElementHandler_( *(document_filler__ *)UserData, Name );
}
...
static void DBSEndElementHandler_(
	...
	const XML_Char *Name )
{
	EndElementHandler_( *(database_filler__ *)UserData, Name );
}
...
static void DCMCharacterDataHandler_(
	...
	int Len )
{
	CharacterDataHandler_( *(document_filler__ *)UserData, S, Len );
}
...
static void DBSCharacterDataHandler_(
	...
	int Len )
{
	CharacterDataHandler_( *(database_filler__ *)UserData, S, Len );
}
...
ERRProlog
	...
	txf::amount__ Amount;
ERRBegin
	if ( ( Buffer = (txf::datum__ *)XML_GetBuffer( Parser, Length ) ) == NULL )
		ERRm();
