...
template <typename t> static epeios::row__ Search_(
	id__ Id,
	const bch::E_BUNCH_( t ) &Bunch )
{
	epeios::row__ P = Bunch.First();
...
bso::bool__ clnarg::analyzer___::GetArgument_( 
	...
	argument_ &Argument )
{
	epeios::row__ P = Search_( Option, Description_->Options );
