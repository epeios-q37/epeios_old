/*
	Test source for the 'mscvkt' library by Claude SIMON (http://zeusw.org/intl/contact.html).
...
ERRFProlog
ERRFBegin
	cout << "Test of library " << MSCVKTTutor.Name << ' ' << __DATE__" "__TIME__"\n";
...
ERRFEnd
	cout << "\nEnd of program " << MSCVKTTutor.Name << ".\n";
ERRFEpilog
	return ExitCode;
}
