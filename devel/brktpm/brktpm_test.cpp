/*
  Test source for the 'brktpm' library by Claude SIMON (http://zeusw.org/intl/contact.html).
...
ERRFProlog
ERRFBegin
	fout << "Test of library " << BRKTPMTutor.Name << ' ' << __DATE__" "__TIME__"\n";
...
ERRFEnd
	fout << "\nEnd of program " << BRKTPMTutor.Name << ".\n";
ERRFEpilog
	return ExitCode;
}
