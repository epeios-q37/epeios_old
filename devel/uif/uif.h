/*
	Header for the 'uif' library by Claude SIMON (csimon@epeios.org)
...
#define	UIF_VERSION	"$Revision$"

#define UIF_OWNER		"Claude SIMON (csimon@epeios.org)"

#include "ttr.h"

extern class ttr_tutor &UIFTutor;

#if defined( XXX_DBG ) && !defined( UIF_NODBG )
#define UIF_DBG
#endif
