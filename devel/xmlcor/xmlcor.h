/*
	Header for the 'xmlcor' library by Claude SIMON (csimon at zeusw dot org)
...
#define XMLCOR_OWNER		"Claude SIMON"
...
/* Addendum to the automatic documentation generation part. */
//D Hierarchically Organized Structures CORe
/* End addendum to automatic documentation generation part. */

#error "No more in use !"
...
namespace xmlcor {
	...
	protected:
		...
		void JumpToTag_( tag_row__ TagRow )
		{
#ifdef XMLCOR_DBG
			if ( *TagRow >= XMLC_->Amount() )
				ERRu();
#endif
			TagRow_ = TagRow;
		}
