/*
	Header for the 'edaemon' module by Claude SIMON (http://zeusw.org/epeios/contact.html).
	Part of th 'edaemon' tool. See http://intl/edaemon/
...
# define AFFILIATION		EPSMSC_EPEIOS_PROJECT_AFFILIATION
# define DEPENDENCE			EPSMSC_EPEIOS_FRAMEWORK_DEPENDENCE
