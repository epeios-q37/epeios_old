...
# endif
	...
	public:
		...
		FBLBRQ_M( SInt, sint__ )
		FBLBRQ_M( SInts, sints_t_ )
		FBLBRQ_M( UInt, uint__ )
		FBLBRQ_M( UInts, uints_t_ )
		FBLBRQ_M( Id8, id8_t__ )
		FBLBRQ_M( Ids8, ids8_t_ )
		FBLBRQ_M( XIds8, xids8_t_ )
		FBLBRQ_M( Id16, id16_t__ )
		FBLBRQ_M( Ids16, ids16_t_ )
		FBLBRQ_M( XIds16, xids16_t_ )
		FBLBRQ_M( Id32, id32_t__ )
		FBLBRQ_M( Ids32, ids32_t_ )
		FBLBRQ_M( XIds32, xids32_t_ )
		FBLBRQ_M( Id, id_t__ )
		FBLBRQ_M( Ids, ids_t_ )
