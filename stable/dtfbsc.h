/*
  Header for the 'dtfbsc' library by Claude L. Simon (epeios@epeios.org)
...
#define DTFBSC_OWNER		"IDEALX (http://www.IDEALX.com/)"
...
namespace dtfbsc {
	...
	inline bso__ubyte GetByte( flw::iflow___ &Flow )
	{
		return Flow.Get();
	}
};
