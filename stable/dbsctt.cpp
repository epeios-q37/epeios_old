...
ERRBegin
	...
	Exists = Set_( S_.MemoryDriver.Storage, ContentFileNameBuffer, content_::Storage.Memory );
	...
	if ( Set_( S_.MemoryDriver.Entries, EntriesFileNameBuffer, Entries.Bunch() ) != Exists )
		ERRu();
