...
# ifdef CPE__MAC
	// Pour éviter l'inclusion de <string.h>, qui entre en conflit avec la bibliothèque 'fls'.
	// NOTA : toutes les fonctions ci-dessous ne sont pas utilisées par cette bibliothèque, mais par d'autres bibliothèques l'appelant.
