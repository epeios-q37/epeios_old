/*
	Header for the 'mmisub' library by Claude SIMON (csimon@epeios.org)
...
#define	MMISUB_VERSION	"$Revision$"

#define MMISUB_OWNER		"Claude SIMON (csimon@epeios.org)"

#include "ttr.h"

extern class ttr_tutor &MMISUBTutor;

#if defined( XXX_DBG ) && !defined( MMISUB_NODBG )
#define MMISUB_DBG
#endif
