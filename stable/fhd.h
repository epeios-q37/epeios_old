/*
  Header for the 'fhd' library by Claude L. Simon (epeios@epeios.org)
...
#define	FHD_VERSION	"$Revision$"	

#define FHD_OWNER		"the Epeios project (http://www.epeios.org/)"

#include "ttr.h"

extern class ttr_tutor &FHDTutor;

#if defined( XXX_DBG ) && !defined( FHD_NODBG )
#define FHD_DBG 
#endif
