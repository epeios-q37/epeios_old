...
class NS_NO_VTABLE NS_SCRIPTABLE iemobdacom : public nsISupports {
 public: 
  ...
  /* void RegisteringStart (in string Language); */
  NS_SCRIPTABLE NS_IMETHOD RegisteringStart(const char *Language) = 0;
...
#define NS_DECL_IEMOBDACOM \
  NS_SCRIPTABLE NS_IMETHOD RegisteringStart(const char *Language); \
...
#define NS_FORWARD_IEMOBDACOM(_to) \
  NS_SCRIPTABLE NS_IMETHOD RegisteringStart(const char *Language) { return _to RegisteringStart(Language); } \
...
#define NS_FORWARD_SAFE_IEMOBDACOM(_to) \
  NS_SCRIPTABLE NS_IMETHOD RegisteringStart(const char *Language) { return !_to ? NS_ERROR_NULL_POINTER : _to->RegisteringStart(Language); } \
...
/* void RegisteringStart (in string Language); */
NS_IMETHODIMP _MYCLASS_::RegisteringStart(const char *Language)
{
